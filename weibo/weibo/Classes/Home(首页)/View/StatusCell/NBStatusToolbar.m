...
@implementation NBStatusToolbar
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.image = [UIImage resizeImageWithNamed:@"timeline_card_bottom_background"];
...
- (UIButton *)setupBtnWithIcon:(NSString *)icon title:(NSString *)title
{
    ...
    // 设置高亮时的背景
    [btn setBackgroundImage:[UIImage resizeImageWithNamed:@"common_card_bottom_background_highlighted"] forState:UIControlStateHighlighted];
