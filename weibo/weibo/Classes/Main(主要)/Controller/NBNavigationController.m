...
+ (void)setupNavigationBarTheme
{
    ...
    textAttrs[UITextAttributeFont] = NBNavigationTitleFont;
...
+ (void)setupBarButtonItemTheme
{
    ...
    [appearance setBackgroundImage:[UIImage imageWithNamed:@"navigationbar_button_background"] forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
}
